<template>
	<div class="privacy-policy max-w-4xl mx-auto px-4 py-8">
		...
		<div class="mb-8 px-4 text-left">
			<div class="mb-6">
				欢迎您使用 Bazinga
				英语学习平台。本平台由魔力多奇实验室（以下简称"我们"）开发及运营，致力于为用户提供语言学习辅助工具。我们高度重视用户隐私和个人信息保护，严格遵守相关法律法规。本政策将帮助您了解我们如何收集、使用和保护您的信息。
			</div>
			...
			<div class="mt-4 p-4 bg-base-200 rounded-lg">
				<strong>特别提示：</strong
				>我们严格保护您的个人信息，但在您使用第三方服务时，需要注意区分第三方的信息收集行为及其隐私政策。
			</div>
		</div>
